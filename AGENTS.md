...
Agents must prioritize the rules and conventions defined in [CONTRIBUTING.md](CONTRIBUTING.md). The
Hard Rules below are the source-of-truth ruleset; keep them in sync with CONTRIBUTING.md.
...
- CHECK your diffs for sensitive information (SAP hostnames, credentials) before committing.
