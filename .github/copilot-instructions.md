...
> `tools/gen-ai-docs.mjs` so CLAUDE.md, AGENTS.md and this file stay identical. Edit the partial
> (kept in step with `CONTRIBUTING.md`), then run `node tools/gen-ai-docs.mjs`. Do not edit inside
> the markers.
